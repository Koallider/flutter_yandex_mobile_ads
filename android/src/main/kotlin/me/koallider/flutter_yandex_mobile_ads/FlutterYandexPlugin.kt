    ...
    mInterstitialAd!!.setInterstitialAdEventListener(object : InterstitialAdEventListener {
      override fun onAdLoaded() {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_INTERSTITIAL_AD_READY, null)
        }
      ...
      override fun onAdShown() {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_INTERSTITIAL_AD_OPENED, null)
        }
        Log.d(TAG, "onAdShown")
      }
      ...
      override fun onAdDismissed() {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_INTERSTITIAL_AD_CLOSED, null)
        }
      ...
      override fun onAdClicked() {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_INTERSTITIAL_AD_CLICKED, null)
        }
      ...
      override fun onImpression(p0: ImpressionData?) {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_INTERSTITIAL_AD_SHOW_SUCCEEDED, null)
        }
    ...
    mRewardedAd!!.setRewardedAdEventListener(object : RewardedAdEventListener {
      override fun onAdLoaded() {
        mActivity.runOnUiThread {
          mChannel.invokeMethod(YandexConsts.ON_REWARDED_AD_READY, null)
        }
        Log.d(TAG, "onAdLoaded")
      }
      ...
      override fun onImpression(p0: ImpressionData?) {
        mActivity.runOnUiThread { //back on UI thread...
          mChannel.invokeMethod(YandexConsts.ON_REWARDED_VIDEO_AD_STARTED, null)
        }
        Log.d(TAG, "onImpression")
      }
